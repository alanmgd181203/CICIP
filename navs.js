...
const navsEdificio1 = `
    ...
    <div id="nav-cantera-a-pruebas" class="nav-escena-4"
         ...
         onclick="saltoLateral('assets/imagen-7.webp', 'Lab de Pruebas', 'nav-cantera-a-pruebas', 'nav-pruebas-a-cantera nav-pruebas-a-morteros nav-pruebas-a-sanitarios nav-pruebas-a-vestibulo-1 nav-pruebas-a-vestibulo-2 camara-pruebas1-49 camara-pruebas1-50 camara-pruebas1-51')"
    ...
    <div id="nav-cantera-a-sanitarios" class="nav-escena-4"
         ...
         onclick="saltoLateral('assets/imagen-12.webp', 'Sanitarios', 'nav-cantera-a-sanitarios', 'nav-sanitarios-a-cantera nav-sanitarios-a-pruebas nav-sanitarios-a-morteros nav-sanitarios-a-conservprev nav-sanitarios-a-principal nav-sanitarios-a-vestibulo camara-sanitarios1-53')"
    ...
    <div id="nav-pruebas-a-sanitarios" class="nav-escena-4"
         ...
         onclick="saltoLateral('assets/imagen-12.webp', 'Sanitarios', 'nav-pruebas-a-sanitarios', 'nav-sanitarios-a-cantera nav-sanitarios-a-pruebas nav-sanitarios-a-morteros nav-sanitarios-a-conservprev nav-sanitarios-a-principal nav-sanitarios-a-vestibulo camara-sanitarios1-53')"
         onmouseenter="mostrarInfo('Ir a Sanitarios')"
         onmouseleave="ocultarInfo()">
    ...
    <div id="nav-morteros-a-pruebas" class="nav-escena-4"
         ...
         onclick="saltoLateral('assets/imagen-7.webp', 'Lab de Pruebas', 'nav-morteros-a-pruebas', 'nav-pruebas-a-cantera nav-pruebas-a-morteros nav-pruebas-a-sanitarios nav-pruebas-a-vestibulo-1 nav-pruebas-a-vestibulo-2 camara-pruebas1-49 camara-pruebas1-50 camara-pruebas1-51')"
         onmouseenter="mostrarInfo('Ir a Lab de Pruebas')"
         onmouseleave="ocultarInfo()">
    ...
    <div id="nav-morteros-a-sanitarios" class="nav-escena-4"
         ...
         onclick="saltoLateral('assets/imagen-12.webp', 'Sanitarios', 'nav-morteros-a-sanitarios', 'nav-sanitarios-a-cantera nav-sanitarios-a-pruebas nav-sanitarios-a-morteros nav-sanitarios-a-conservprev nav-sanitarios-a-principal nav-sanitarios-a-vestibulo camara-sanitarios1-53')"
         onmouseenter="mostrarInfo('Ir a Sanitarios')"
         onmouseleave="ocultarInfo()">
    ...
    <div id="nav-sanitarios-a-pruebas" class="nav-escena-4"
         ...
         onclick="saltoLateral('assets/imagen-7.webp', 'Lab de Pruebas', 'nav-sanitarios-a-pruebas', 'nav-pruebas-a-cantera nav-pruebas-a-morteros nav-pruebas-a-sanitarios nav-pruebas-a-vestibulo-1 nav-pruebas-a-vestibulo-2 camara-pruebas1-49 camara-pruebas1-50 camara-pruebas1-51')"
         onmouseenter="mostrarInfo('Ir a Lab de Pruebas')"
         onmouseleave="ocultarInfo()">
